    ...
    <div  style="font-weight:bolder;font-size:17px;text-decoration: underline;color:#000099">ตรวจสอบเงินสด</span>   
        <table class="DataSourceFormView" style="width:270px">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="as_userid" runat="server" Width="70%" style="text-align:center" BackColor="Yellow" ForeColor="Red"></asp:TextBox>                                   
                    <asp:Button ID="b_user" runat="server" Text="..." Width="20%" />    
                 </td>           
            </tr>
        </table>
    </EditItemTemplate>
