...
namespace Saving.Applications.cmd
{
    public partial class w_sheet_cmd_ptdurtmaster : PageWebSheet, WebSheet
    {
        ...
        {
            String durt_id = "", durt_regno = "", durt_name = "", durtgrp_code = "", brand_name = "", model_desc = "", serial_number = "", dealer_no="";
            ...
            try
            {
                ...
                try { serial_number = DwMain.GetItemString(1, "durtserial_number").Trim(); }
                catch { serial_number = ""; }
                ...
                if (durt_id == "AUTO")
                {
                    ...
                    try
                    {
                        String insert = @"insert into ptdurtmaster
                                ...
                                buy_date, durtgrpsub_code ,
                                dealer_no,durtserial_number)values
                                ('" + durt_id + "','" + durt_regno + "','" + durt_name + "','" + durtgrp_code + @"',
                                '" + brand_name + "','" + model_desc + "','" + unit_code + @"',
                                '" + lot_id + "','" + dept_code + "','" + holder_name + @"',
                                 " + devalue_percent + "," + devaluelastcal_year + @",
                                " + unit_price + ",to_date('" + devaluestart_date.ToString("dd/MM/yyyy") + @"','dd/MM/yyyy'),
                                to_date('" + buy_date.ToString("dd/MM/yyyy") + @"','dd/MM/yyyy'), '" + durtgrpsub_code + "' ,'" + dealer_no + "','" + serial_number + "')";
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        String upsql = @"update ptdurtmaster
                                ...
                                dealer_no ='" +dealer_no+"',serial_number ='" +serial_number+"' "+
        ...
        private void jsPostFindShow()
        {
            ...
            try
            {
                String se = @"select durt_id, durt_regno,durt_name ,durtgrp_code,brand_name,model_desc,unit_code,unit_price,
                          buy_date,lot_id,devalue_percent,DEVALUESTART_DATE,devaluelastcal_year,dept_code,holder_name, durtgrpsub_code ,dealer_no,durtserial_number
