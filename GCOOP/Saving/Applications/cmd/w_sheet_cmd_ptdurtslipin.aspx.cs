...
namespace Saving.Applications.cmd
{
    public partial class w_sheet_cmd_ptdurtslipin : PageWebSheet, WebSheet
    {
        ...
        public void SaveWebSheet()
        {
            ...
            string dealer_no = "", durtgrpsub_code = "";
            ...
            try
            {
                ...
                if (slipin_no == "AUTO")
                {
                    ...
                    try
                    {
	                    ...
	                    durtgrp_code, durtrcv_code, slip_status, entry_id, entry_date, ref_docno, durtgrpsub_code, dealer_no ) values
                        ...
                        '" + ref_docno + "', '" + durtgrpsub_code + "', '"+ dealer_no +"')";
                    ...
                    for (Int32 i = 1; i <= rowde; i++)
                    {
                        ...
                        ( '" + durt_id + "', '" + durt_regno + "', '" + durt_name + "', '" + durtgrp_code + "', '" + brand_name + "', '" + model_desc + @"',
                          ...
                          1, " + unit_price + ",'" + durtgrpsub_code + "', '"+ dealer_no +"')";
                            ta = WebUtil.QuerySdt(insert);
                        }
                        catch (Exception ex)
                        { LtServerMessage.Text = WebUtil.ErrorMessage(ex); }
