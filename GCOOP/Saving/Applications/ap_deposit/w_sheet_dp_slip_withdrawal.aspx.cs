    ...
    public partial class w_sheet_dp_slip_withdrawal : PageWebSheet, WebSheet
    {
            ...
            try
            {
                ...
                if (deptWithFlag == "/")
                {
                    ...
                    if (deptWithFlag == "/" && state.SsCoopId == "027001" && deptTypeCode == "17" || deptTypeCode == "09" || deptTypeCode == "14" || deptTypeCode == "29" || deptTypeCode == "39")
                    {
                        ...
                        else if ((deptTypeCode == "09" && v_principal > 0 && v_interest > 0) || (deptTypeCode == "14" && v_principal > 0 && v_interest > 0) || (deptTypeCode == "29" && v_principal > 0 && v_interest > 0) || (deptTypeCode == "39" && v_principal > 0 && v_interest > 0))
                        {
        ...
        private void Withdraw()
        {
            try
            {
                ...
                //08 28 38 ไม่ให้ยิงค่าปรับลง slip DwMain.GetItemDecimal(1, "other_amt")
