        ...
        public void SaveWebSheet()
        {
            try
            {
                ...
                if (deptAccNo != "" && deptAccNo != null)
                {
                    ...
                    {
                        decimal rateStatus, monthintpay_meth, bookconfirm_status, limitprnbal_flag, limitprnbal_amt, taxStatus, f_tax_rate, prnc_no, laststmseq_no, withdraw_count;
                        ...
                        try
                        {
                            string update_deptmas = "update DPDEPTMASTER set spcint_rate_status = '" + rateStatus + "',condforwithdraw='" + condforwithdraw + @"',
