...
namespace Saving.Applications.ap_deposit
{
    public partial class w_sheet_dp_truncate : PageWebSheet, WebSheet
    {
        ...
        private void JsPostRetrive()
        {
            ...
            DwUtil.RetrieveDDDW(Dw_Main, "as_memno", pbl, null);
        }
        ...
        private void JsPostRetriveDepttrans()
        {
           ...
           // Dw_Detail.Retrieve();
            ...
            Decimal status_memno = Dw_Main.GetItemDecimal(1, "ai_member_flag");
            ...
            if (status_memno == 1)
            {
                ls_memno = Dw_Main.GetItemString(1, "as_memno").Trim();
            }
            else
            {
                ls_memno = "%";
            ...
            DwUtil.RetrieveDataWindow(Dw_Detail, "dp_depttrans.pbl", null, YYMM, smemtype_code, ememtype_code, sgroup_type, egroup_type, ls_memno);
        }
