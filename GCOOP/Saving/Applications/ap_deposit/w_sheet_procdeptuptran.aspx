    ...
    <script type="text/javascript">
        ...
        function OnDwMainButtonClick(sender, row, bName) {
            if (bName == "btn_process") {
                ...
                if (isConfirm) {
                    sender.AcceptText()
                    if (objDw_accid.GetItem(1, "account_id") == null) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td >
                <dw:WebDataWindowControl ID="Dw_accid" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
                    AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True" DataWindowObject="d_dp_accountid"
                    LibraryList="~/DataWindow/ap_deposit/dp_depttrans.pbl" ClientEventButtonClicked ="OnDwAccidButtonClick" 
                    ClientEventItemChanged="OnDwAccidOnChange" ClientFormatting="True">
                </dw:WebDataWindowControl>
            </td>
        </tr>
        <tr>
