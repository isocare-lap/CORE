...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            var loancontract_no = dsDetailLoan.GetItem(r, "loancontract_no");
            */
            var txt_alert = "";
            if (check == true) {
                for (var i = 0; i < dsDetailLoan.GetRowCount(); i++) {
                    if (dsDetailLoan.GetItem(i, "item_balance") == 0) {
                        txt_alert += "เลขสัญญา " +dsDetailLoan.GetItem(i, "loancontract_no") + " ยังมีต้นรอเรียกเก็บ : " + dsDetailLoan.GetItem(i, "rkeep_principal")+" บาท\n";
                    }
                }
                return confirm(txt_alert + "ยืนยันการบันทึกข้อมูล");
            }
        }
