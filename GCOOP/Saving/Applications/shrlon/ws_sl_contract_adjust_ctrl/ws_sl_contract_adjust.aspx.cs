    ...
    public partial class ws_sl_contract_adjust : PageWebSheet, WebSheet
    {
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == PostPeriodPayamt)
            {
                ...
                Decimal li_installment = dsPayment.DATA[0].PERIOD_PAYAMT; 
                Decimal ldc_loanprin = dsMain.DATA[0].PRINCIPAL_BALANCE; 
                int li_paymenttype = Convert.ToInt32(dsPayment.DATA[0].LOANPAYMENT_TYPE); 
                ...
                switch (li_paymenttype)
                {
                    ...
                    case 2:
                        ...
                        ldc_periodpay = Convert.ToDecimal((Convert.ToDouble(ldc_loanprin) * (Convert.ToDouble(ldc_intrate) * ldb_fd)) / ((1.00 - ldc_fr)));
                        break;
                    case 3:
                        ldc_periodpay = 0;
                        ldc_lastperiodpay = ldc_loanprin;
                ...
                dsPayment.DATA[0].PERIOD_PAYMENT = ldc_periodpay;
            }
        }
