            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem Value="GETDATASMS">0.1 ประมวลดึงรายการรอส่งSMS</asp:ListItem>
                        <asp:ListItem Value="GETCONFIRMSMS">0.2 ประมวลยืนยันรายการรอส่งSMS</asp:ListItem>
                        <asp:ListItem Value="select * from v_SMSTRANSACTION_FLAG_8">1.1 สรุปรายการรอยืนยันส่งSMS</asp:ListItem>
                        <asp:ListItem Value="select * from v_SMSTRANSACTION_FLAG_0">1.2 สรุปรายการรอส่งSMS</asp:ListItem>
                        <asp:ListItem Value="select * from v_SMSTRANSACTION_FLAG_1">2.1 สรุปรายการส่งSMSสำเร็จ</asp:ListItem>
                        <asp:ListItem Value="select * from v_SMSTRANSACTION_FLAG_F">2.2 สรุปรายการส่งSMSไม่สำเร็จ</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
