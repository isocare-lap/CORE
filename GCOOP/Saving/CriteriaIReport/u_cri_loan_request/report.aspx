       ...
       <td width="20">
            ...
            <td width="120">
                <asp:DropDownList ID="loangrp1" runat="server">
                        <asp:ListItem Value="10"> ฉุกเฉิน - 10</asp:ListItem>
                        <asp:ListItem Value="20"> สามัญ - 20</asp:ListItem>
                        <asp:ListItem Value="30"> พิเศษเพื่อการเคหะสงเคราะห์ - 30</asp:ListItem>
